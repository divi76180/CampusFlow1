...
(1, 1, 'Casual / Home Visit', CURRENT_DATE + INTERVAL '1 day', CURRENT_DATE + INTERVAL '3 days', '08:00:00', '18:00:00', 'Visiting family for annual festival', '42, Temple Street, Madurai, Tamil Nadu - 625001', '9876543210', 'Completed', 'completed'),
...
(1, 'parent', 3, 'approved', 'Voice Biometric Confirmed (95.4% match)'),
(1, 'advisor', 5, 'approved', 'Academic attendance verified (>85%)'),
(1, 'hod', 6, 'approved', 'Department leave sanctioned. Forwarded to Warden.'),
(1, 'warden', 7, 'approved', 'Hostel Gate Pass issued. Safe travels.');

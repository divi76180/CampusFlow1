...
(function(root, factory) {
    ...
    let anonKey = localStorage.getItem('campusflow_supabase_key') || '';
    ...
    async function login(username, password) {
        const sb = initClient();
        if (!sb) {
            return { success: false, message: 'Supabase client is not configured with an API Key. Please provide the anon key.' };
        }
